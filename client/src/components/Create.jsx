...
const Create = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white flex justify-center items-center">
      <form className="bg-gradient-to-r from-purple-700 via-purple-800 to-purple-900 shadow-md rounded px-8 pt-6 pb-8 mb-4 text-white">
        <div className="mb-4">
        ...
        <div className="flex items-center justify-center">
          <button
            className="bg-black border-2 border-purple-500  text-white font-bold py-2 px-4 rounded-lg "
            type="button"
